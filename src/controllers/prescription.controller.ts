...
class PrescriptionController implements BaseController {
    ...
    public create = async (req: Request, res: Response): Promise<Response> => {
        console.log('Creando nueva prescripción...',);
    ...
    private createPrescriptionAndes = async (newPrescription: IPrescription, profesional: IUser, patient: IPatient) => {
        console.log('Creando receta en ANDES...', newPrescription, profesional, patient);
        ...
        try {
            ...
            console.log('Respuesta de ANDES al crear la receta:', respAndes.data);
